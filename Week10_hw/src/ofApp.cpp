...
float Rad = 100;		//circle radius parameter
...
const int n = 1000;		//number of circles
...
void ofApp::setup(){
    ...
    //Set up sound sample
//    sound.loadSound( "la-roux-bulletproof-donk-soundcloud.mp3" );
    sound.loadSound( "Safri Duo - The Bongo Song.mp3" );
...
//--------------------------------------------------------------
void ofApp::draw(){
    ofBackground(0, 0, 0);	//background white
